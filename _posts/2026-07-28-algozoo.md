...
Hilton's post prefaces their inability to fully define what a "Mechanistic Description" entails. I will not strive for a formal definition either, but here are some examples of what counts; they all revolve around the idea of "the ability to control":
...
2. You can describe with precisely what classes of inputs the model will fail on (e.g. "input coordinates falling in this convex cone will produce the wrong answer").
...
**Step 1:** input $$x_0$$ is embedded (projected) onto 