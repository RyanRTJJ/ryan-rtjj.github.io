...
published: true
title: ICA vs SAEs &#x2B50;
description: "Connecting independent component analysis (ICA) to sparse autoencoders (SAEs) as blind source separation — walking through Lewicki & Sejnowski, with an ICA implementation."
image:
  path: /images/ica/exponential_toy_data.png
  alt: "Exponentially-distributed toy data for ICA"
