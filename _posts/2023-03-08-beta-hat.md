...
description: "Derivation of the OLS (ordinary least squares) coefficients beta-hat, plus the expected value and covariance of beta-hat in linear regression."
