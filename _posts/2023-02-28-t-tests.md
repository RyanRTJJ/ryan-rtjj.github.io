...
description: "Derivation of the t-test, the t-statistic, and the sample variance s² (s^2) — including why we divide by n−1 for the unbiased estimator of variance."
image:
  path: /images/alpha5.png
  alt: "Significance level α = 0.05 region under the distribution"
